...
cd certificates || { echo "cd into certificates failed"; exit 1; }
...
for i in controller1 controller2 controller3 broker1 broker2 broker3 schema-registry connect control-center rest-proxy client akhq
do
	echo "------------------------------- $i -------------------------------"
